...
from .attribution import (BrinsonAttribution, FactorAttribution,
...
try:
    ...
    def calculate_risk_metrics(*args, **kwargs): return {}

from .tear_sheets import (TearSheet, create_bayesian_tear_sheet,
