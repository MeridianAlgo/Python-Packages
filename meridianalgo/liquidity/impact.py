...
class ImpactModel:
    ...
    def fit(
        ...
        merged['daily_volume'] = merged.groupby(
    ...
    def predict(
        ...
        if 'lambda' in self.params:
            ...
            return self.params['eta'] * volatility * (participation ** self.params['delta'])
        else:
...
class AlmgrenChrissImpact:
    ...
    def expected_cost(self) -> Dict[str, float]:
        ...
        if kappa * self.T < 0.001:
            ...
            temporary_cost = (self.eta * self.sigma * self.X**2 * 
    ...
    def sensitivity_analysis(self) -> Dict[str, pd.DataFrame]:
        ...
        for vol in vol_range:
            ...
            vol_costs.append({
                ...
                'cost_change': (self.expected_cost()['total_cost'] - base_cost) / base_cost
            })
            self.sigma = orig
