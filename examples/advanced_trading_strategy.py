...
class TradingStrategy:
    ...
    def generate_signals(self, data):
        ...
        for ticker in data.columns:
            ...
            # Exit signals
            signals.loc[(zscore > -self.exit_threshold) & (zscore < self.exit_threshold), f'{ticker}_signal'] = 0
    ...
    def backtest(self, data, initial_capital=100000):
        ...
        for date in data.index[1:]:
            ...
            daily_return = (portfolio_value - current_portfolio_value) / current_portfolio_value
